...
int list_push_value(node_t **head, int value);
int list_push_value_priority(node_t **head, void *value, size_t max_pos);
void list_unshift(node_t **head, node_t *node);
int list_unshift_value(node_t **head, int value);
int list_insert(node_t **head, node_t *node, size_t index);
int list_insert_value(node_t **head, int value, size_t index);
...
void list_apply_darg(node_t *head, void (*func)(node_t *, void *, void *),
                     void *arg1, void *arg2);
